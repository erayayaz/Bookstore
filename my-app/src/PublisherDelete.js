...
class PublisherDelete extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      publisherId: 0,
  ...
  deletePublisher = () => {
    fetch(
      `http://localhost:8081/api/admins/delete_publisher/${this.state.publisherId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export default withRouter(PublisherDelete);
