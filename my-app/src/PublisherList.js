...
class PublisherList extends React.Component {
  ...
  getBooks = () => {
    fetch(
      "http://localhost:8081/api/admins/get_publisher_page?" +
              ...
              <Grid.Column width={16}>
                ...
                <Table celled>
                  ...
                  <Table.Body>
                    {publishers &&
                      publishers.content &&
                      publishers.content.map((value, index) => (
                        <Table.Row>
                          <Table.Cell>
                            <Label ribbon>
                              {publishers.size * publishers.number +
                                (index + 1)}
                            </Label>
                          </Table.Cell>
                      ...
                      <Table.HeaderCell colSpan="5">
                        <Menu floated="right" pagination>
                          <Menu.Item
                            ...
                            as="a"
                            icon
                            disabled={publishers.first}
                          >
                            <Icon name="chevron left" />
                          </Menu.Item>
                          {[...Array(publishers.totalPages).keys()].map(
                            (value, index) => (
                              <Menu.Item
                                as="a"
                                onClick={() => {
                                ...
                                active={publishers.number === index}
                              >
                                {index + 1}
                              </Menu.Item>
                            )
